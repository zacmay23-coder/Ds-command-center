...
`zacheryaaronmay@gmail.com` and `zacmay23@gmail.com` are restored to active
administrators whenever either authenticated Firebase account signs in. This
repairs an accidentally removed,
